...
class Require:
    ...
    def getUserAgentt(self):
        ...
        C = f"Mozilla/5.0 (Linux; Android {str(random.randint(8,12))};  V2111 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(random.randint(75,120))}.0.{str(random.randint(4500,5500))}.{str(random.randint(75,150))} Mobile Safari/537.36 Instagram {versi} Android (27/8.1.0; {dpis}; 480x854; ITEL MOBILE LIMITED/Itel; itel A16 Plus RU; itel-A16-Plus; sp7731e_1h10; ru_RU; 284459212);  {com}; {basa}; {kode})"
        D = f"Mozilla/5.0 (Linux; Android {str(random.randint(8,12))}; I2018 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(random.randint(75,120))}.0.{str(random.randint(4500,5500))}.{str(random.randint(75,150))} Mobile Safari/537.36 Instagram {versi} Android (28/9; {dpis}; 1080x2131; samsung; SM-A505FN; a50; exynos9610; fi_FI; 221134032); {com}; {basa}; {kode})"
        E = f"Mozilla/5.0 (Linux; Android {str(random.randint(8,12))}; I2217 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(random.randint(75,120))}.0.{str(random.randint(4500,5500))}.{str(random.randint(75,150))} Mobile Safari/537.36 Instagram {versi} Android (29/10; {dpis}; 720x1464; INFINIX MOBILITY LIMITED/Infinix; Infinix X682B; Infinix-X682B; mt6769; tr_T; {com}; {basa}; {kode})"
        F = f"Mozilla/5.0 (Linux; Android {str(random.randint(8,12))}; I2018 Build/{build,}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(random.randint(75,120))}.0.{str(random.randint(4500,5500))}.{str(random.randint(75,150))} Mobile Safari/537.36 Instagram {versi} Android (31/12; {dpis}; 720x1421; HMD Global/Nokia; N156DL; DGF; mt6762; ru_RU; 627400390; {com}; {basa}; {kode})"
        G = f"Mozilla/5.0 (Linux; Android {str(random.randint(8,12))}; I2223 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(random.randint(75,120))}.0.{str(random.randint(4500,5500))}.{str(random.randint(75,150))} Mobile Safari/537.36 Instagram {versi} Android (24/7.0; {dpis}; 1920x1080; Xiaomi/xiaomi; Redmi Note 4; mido; qcom; ru_RU; 98288242); {com}; {basa}; {kode})"
...
class Brute:
    ...
    def followme(self, tok, cok):
        try:
            headers = {"Host": "i.instagram.com","content-length": "0","sec-ch-ua": '" Not A;Brand";v="99", "Chromium";v="124", "Google Chrome";v="124"',"x-ig-app-id": "1217981644879628","x-ig-www-claim": "hmac.AR1HCGj0ZapocVrefjfTlgStsy8tesXJZh1fqUdNPcprMknJ","sec-ch-ua-mobile": "?1","x-instagram-ajax": "1016035497","viewport-width": "360","content-type": "application/x-www-form-urlencoded","accept": "*/*","user-agent": "Instagram 37.0.0.21.97 Android (21/5.0.1; 480dpi; 1080x1794; HUAWEI; HUAWEI GRA-L09; HWGRA; hi3635; hu_HU; 98288242)","x-asbd-id": "129477","save-data": "on","x-csrftoken": tok,"sec-ch-ua-platform": '"Android"',"origin": "https://www.instagram.com","sec-fetch-site": "same-site","sec-fetch-mode": "cors","sec-fetch-dest": "empty","referer": "https://www.instagram.com/","accept-encoding": "gzip, deflate, br","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
        ...
        while True:
            try:
                ...
                headers.update({
                    ...
                    "x-asbd-id": "129477",
                    "dpr": "1.4375",
                    "sec-ch-ua-full-version-list": '"Chromium";v="124.0.6327.4", "Not(A:Brand";v="99.0.0.0"',
                    "sec-ch-prefers-color-scheme": "light",
